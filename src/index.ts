...
import {
  ...
  handleDuplicateForm,
  handleExportFormDefinition,
  handleGetForm,
  handleGetSubmission,
  handleListFieldTypes,
  handleListFormSubmissions,
  handleListFormVersions,
  handleListForms,
  handlePublishForm,
  handlePublicGetForm,
  handlePublicSubmitForm,
  handleReorderFormFields,
  handleRestoreFormVersion,
  handleSaveFormDraft,
  handleUpdateForm,
...
const ROUTES: RouteDefinition[] = [
  ...
  staticRoute("GET", "/api/forms/field-types", handleListFieldTypes),
  ...
  paramRoute("PUT", "/api/forms/:id/draft", handleSaveFormDraft),
  paramRoute("POST", "/api/forms/:id/publish", handlePublishForm),
  paramRoute("POST", "/api/forms/:id/duplicate", handleDuplicateForm),
  paramRoute("GET", "/api/forms/:id/versions", handleListFormVersions),
  paramRoute("POST", "/api/forms/:id/versions/:versionId/restore", handleRestoreFormVersion),
  paramRoute("GET", "/api/forms/:id/export", handleExportFormDefinition),
